...
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (8, 2, 'Competitive Media Reporting, LLC');
...
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (399, 1, 'ReferenceUSA');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (254, 1, 'Audit Analytics');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (159, 2, 'Idea Group Inc');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (87, 3, 'S&P');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (422, 1, 'Morgan Stanley Capital International');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (420, 2, 'RiskMetrics Group');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (267, 3, 'ISS');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (120, 3, 'Readex');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (425, 1, 'Center for the Advancement of the Research Methods and Analysis');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (305, 1, 'ACM Digital Library');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (426, 3, 'MCLS');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (426, 2, 'MLC');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (426, 2, 'Michigan Library Consortia');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (426, 2, 'INCOLSA');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (427, 3, 'PLoS');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (400, 1, 'R.R. Bowker');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (429, 3, 'UNIDO');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (434, 3, 'BAS');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (35, 1, 'APG: Academic and Professional Group');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (44, 2, 'Silverplatter');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (44, 1, 'OvidSP');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (122, 1, 'Naxos Digital Services Ltd');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (37, 3, 'OUP');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (475, 3, 'OECD');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (194, 3, 'ESA');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (173, 1, 'H1Base');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (28, 1, 'ISI');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (484, 1, 'Austrian Academy of Sciences Press');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (485, 3, 'ARM');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (485, 1, 'New World Records');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (490, 1, 'CDI Systems Ltd.');
INSERT INTO `_DATABASE_NAME_`.Alias (organizationID, aliasTypeID, name) values (399, 2, 'infogroup');
...
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (8, 'TNS Media Intelligence', NOW(), 'system');
...
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (87, 'Standard and Poors', NOW(), 'system');
...
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (122, 'Naxos of America, Inc.', NOW(), 'system');
...
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (159, 'IGI Global ', NOW(), 'system');
...
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (228, 'Beilstein Information Systems, Inc', NOW(), 'system');
...
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (444, 'Cold North Wind Inc', NOW(), 'system');
...
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (426, 'Midwest Collaborative for Library Services', NOW(), 'system');
...
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (445, 'Coutts', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (446, 'Numara Software, Inc.', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (447, 'Trinity College Library Dublin', NOW(), 'system');
...
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (432, 'Capital IQ', NOW(), 'system');
...
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (420, 'MSCI RiskMetrics', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (421, 'Rapid Multimedia', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (422, 'MSCI Inc', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (423, 'New England Journal of Medicine', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (424, 'NetLibrary', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (425, 'CARMA', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (427, 'Public Library of Science', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (428, 'Social Science Electronic Publishing', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (429, 'United Nations Industrial Develoipment Organization', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (430, 'University of Michigan Press', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (431, 'ORS Publishing, Inc.', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (433, 'McGraw-Hill', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (434, 'Biblical Archaeology Society', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (435, 'GeoLytics, Inc.', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (436, 'JoVE ', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (437, 'ICEsoft Technologies, Inc.', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (438, 'Films Media Group', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (439, 'Films on Demand', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (440, 'Connect Journals', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (441, 'Scuola Normale Superiore', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (442, 'Wolters Kluwer', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (448, 'Pier Professional', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (449, 'ABC News', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (450, 'University of Aberdeen ', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (451, 'BullFrog Films, Inc.', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (453, 'FirstSearch', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (455, 'History Cooperative ', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (456, 'Omohundro Institute of Early American History and Culture', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (457, 'Arms Control Association', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (458, 'Heritage Archives', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (459, 'International Historic Films, Inc.', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (460, 'Euromonitor International ', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (461, 'Safari Books Online', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (462, 'Mirabile', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (466, 'Publishing Technology', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (463, 'SageWorks, Inc', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (464, 'Johns Hopkins Universtiy Press', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (465, 'Knovel ', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (467, 'American Society of Nephrology', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (468, 'Water Envrionment Federation ', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (469, 'Refworks', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (470, 'Cinemagician Productions', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (471, 'Algorithmics', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (472, 'YBP Library Services ', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (474, 'Maydream Inc.', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (475, 'Organization for Economic Cooperation and Development', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (476, 'The Chronicle for Higher Education', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (477, 'Association for Research in Vision and Ophthalmologie (ARVO)', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (478, 'SRDS Media Solutions', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (479, 'Kantar Media', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (480, 'Peace & Justice Studies Association', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (481, 'Addison Publications Ltd.', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (482, 'Mutii-Science Publishing', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (483, 'ASM International', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (484, 'Verlag der Osterreichischen Akademie der Wissenschaften', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (485, 'Anthology of Recorded Music', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (486, 'Left Coast Press, Inc', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (487, 'Video Data Bank', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (488, 'Atlassian', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (489, 'medici.tv', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (490, 'Bar Ilan Research & Development Company Ltd', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (491, 'Primary Source Media', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (492, 'Ebrary', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (493, 'University of Michigan, Department of Mathematics', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (494, 'StataCorp LP ', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (495, 'L\' Enseignement Mathematique  ', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (496, 'Audio Engineering Society, Inc', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (497, 'LOCKSS', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (498, 'MUSEEC ', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (499, 'Mortgage Bankers Association', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (500, 'BibleWorks', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (501, 'National Library of Ireland', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (502, 'Scholars Press', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (503, 'Index to Jewish periodicals', NOW(), 'system');
INSERT INTO `_DATABASE_NAME_`.Organization (organizationID, name, createDate, createLoginID ) values (504, 'Cold Spring Harbor Laboratory Press', NOW(), 'system');
...
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (44, 442);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (87, 433);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (154, 466);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (168, 39);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (228, 29);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (259, 416);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (267, 422);
...
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (420, 422);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (424, 42);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (432, 87);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (439, 438);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (453, 264);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (462, 297);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (469, 270);
INSERT INTO `_DATABASE_NAME_`.OrganizationHierarchy (organizationID, parentOrganizationID) values (478, 479);
