...
INSERT INTO `_DATABASE_NAME_`.AliasType (aliasTypeID, shortName) values (1, "Nom Alternatif");
INSERT INTO `_DATABASE_NAME_`.AliasType (aliasTypeID, shortName) values (2, "Nom Changé");
INSERT INTO `_DATABASE_NAME_`.AliasType (aliasTypeID, shortName) values (3, "Acronyme");

DELETE FROM `_DATABASE_NAME_`.ContactRole;
INSERT INTO `_DATABASE_NAME_`.ContactRole (shortName) values ("Comptable");
INSERT INTO `_DATABASE_NAME_`.ContactRole (shortName) values ("Licences");
...
INSERT INTO `_DATABASE_NAME_`.ExternalLoginType (shortName) values ("Autre");
