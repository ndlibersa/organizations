...
<td style="width:155px;padding-right:10px;">
	...
	<div id='div_searchName' style='<?php if ((!$_SESSION['org_organizationName']) || ($reset == 'Y')) echo "display:none;"; ?>margin-left:123px;'><input type='button' name='btn_searchOrganizationName' value='<?= _("go!");?>' class='searchButton' /></div>
	</td>
	</tr>


	<tr>
	<td class='searchRow'><label for='searchOrganizationRoleID'><b><?= _("Role");?></b></label>
	<br />
	...
	<tr>
	<td class='searchRow'><label for='searchContact'><b><?= _("Contact Name (contains)");?></b></label>
	<br />
	...
	<div id='div_searchContact' style='<?php if ((!$_SESSION['org_contactName']) || ($reset == 'Y')) echo "display:none;"; ?>margin-left:123px;'><input type='button' name='btn_searchContactName' value='<?= _("go!");?>' class='searchButton' /></div>
	</td>
	</tr>
